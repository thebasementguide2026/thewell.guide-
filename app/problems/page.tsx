...
const problems = [
  ...
  { title: 'Signs Your Well Pump Is Failing: 8 Warning Signs and What to Do', href: '/problems/well-pump-failing', description: 'The complete guide to recognizing a failing well pump before it stops working entirely. Eight specific warning signs with urgency levels, the age factor, DIY vs. professional diagnosis, and the repair vs. replace decision framework.', image: '/pressure tank fail.jpg', readTime: '15 min read' },
  { title: 'How to Prime a Well Pump: Step-by-Step Guide 2026', href: '/problems/how-to-prime-a-well-pump', description: 'Prime a shallow well jet pump or convertible jet pump in 5 to 10 minutes with step-by-step instructions. Troubleshooting when priming does not hold, foot valve and check valve diagnosis, and when to call a professional.', image: '/primewellpump.jpg.jpg', readTime: '14 min read' },
]
