      ...
      <article className="py-12">
        <div className="container-custom max-w-3xl">
          ...
          <div className="rounded-xl p-6 mb-6" style={{ borderLeft: '4px solid #854F0B', backgroundColor: '#FAFAF8' }}>
            ...
            <p className="text-slate-800 leading-relaxed mb-4"><strong className="text-slate-900">Cost:</strong> Drilling a new well costs $5,500 to $20,000 all-in for a complete system including the well, casing, pump, pressure tank, electrical, and permit. Properly abandoning the old dug well adds $500 to $2,000. <strong>Total conversion cost: $6,000 to $22,000.</strong> See the <Link href="/cost-guides/well-drilling-cost" className="underline" style={{ color: '#1D9E75' }}>well drilling cost guide</Link> for the full cost breakdown. For homeowners drilling a new modern residential well, our <Link href="/cost-guides/well-drilling-cost-calculator" className="underline" style={{ color: '#1D9E75' }}>well drilling cost calculator</Link> estimates the project cost based on depth, geology, casing size, and pump system.</p>
