...
const guides = [
  { title: 'The Complete Guide to Private Well Water Systems 2026', href: '/guides/complete-well-guide', description: 'Everything a well owner needs to know: how wells work, types of wells and pumps, water quality testing, common contaminants including PFAS and bacteria, maintenance schedules, and when to call a pro.', image: '/wellguidehero.jpg', readTime: '18 min read' },
