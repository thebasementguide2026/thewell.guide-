    ...
    <>
      ...
      <article className='max-w-4xl mx-auto px-6 py-16'>
        ...
        <div className='rounded-2xl p-8 mb-12' style={{ backgroundColor: '#FAEEDA' }}>
          ...
          <p className='text-slate-700 leading-relaxed mb-4'>
            <strong>Confirmed E. coli:</strong> E. coli in your well indicates fecal contamination and a structural problem with the well. UV disinfection kills E. coli effectively, but the Aquasana&apos;s 7 GPM flow limit means any demand spike above that rate receives insufficient UV dose. For E. coli wells, the more important steps are shock chlorination, structural well inspection, and potentially casing or cap repair. See the <a href='/guides/shock-chlorination-well' className='text-[#1D9E75] underline hover:text-[#0F6E56]'>shock chlorination guide</a> and the <Link href='/guides/well-water-contaminants' className='text-[#1D9E75] underline hover:text-[#0F6E56]'>well water contaminants guide</Link>. UV treatment is an ongoing safety net, not a substitute for fixing the source.
          </p>
          <p className='text-slate-700 leading-relaxed mb-4'>
