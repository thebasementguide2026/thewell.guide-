...
const costGuides = [
  ...
  { title: 'Well Pump Replacement Cost Calculator 2026', href: '/cost-guides/well-pump-replacement-cost-calculator', description: 'Free homeowner calculator that estimates well pump replacement cost by pump type, depth, demand, region, and project scope. Built on the same 2026 cost ranges as our cost guide.', image: '/well cost.jpg', readTime: 'Calculator' },
