    ...
    <>
      ...
      <article className='max-w-4xl mx-auto px-4 py-12'>
        ...
        <div className='mb-12'>
          ...
          <p className='text-slate-700 text-sm leading-relaxed mb-4'>If you are replacing the pressure tank alongside the well pump, our <Link href='/cost-guides/well-pump-replacement-cost-calculator' className='font-semibold underline' style={{ color: '#1D9E75' }}>well pump cost calculator</Link> includes an option for combined pump plus pressure tank plus controls replacement. The combined option typically saves $200 to $500 compared to scheduling the replacements separately.</p>
